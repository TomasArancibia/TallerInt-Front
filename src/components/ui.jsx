...
export const contentWrapper =
  "mx-auto mt-3 w-full max-w-2xl text-left text-sm leading-relaxed text-slate-700 sm:max-w-3xl sm:text-base";

export const contentCard =
  "mx-auto mt-3 w-full max-w-2xl rounded-2xl bg-white px-5 py-4 text-left text-sm leading-relaxed text-slate-700 shadow-md ring-1 ring-slate-200 sm:max-w-3xl sm:text-base";
...
export const infoText =
  "mx-auto mt-4 w-full max-w-2xl space-y-4 text-left text-sm leading-relaxed text-slate-700 sm:max-w-3xl sm:text-base";
