      ...
      <div className={infoText}>
        ...
        <div className={`${contentCard} space-y-4`}>
          <div className="space-y-2">
            ...
            <p>
              Documento legal que contiene todos los antecedentes médicos de su atención en la
              institución. Es única por paciente y resguardada bajo confidencialidad.
            </p>
          </div>
          <div className="space-y-2">
            <h3 className="text-base font-semibold text-purple-700">Epicrisis</h3>
            <p>
              Informe que resume su paso por el hospital. Incluye diagnóstico, evolución y
              recomendaciones para el alta. Es útil para continuidad de atención con otros médicos.
            </p>
          </div>
          <div className="space-y-2">
            <h3 className="text-base font-semibold text-purple-700">Protocolo operatorio</h3>
            <p>
              Documento que registra detalladamente cada paso de una intervención quirúrgica, desde
              la preparación del paciente hasta la atención postoperatoria.
            </p>
          </div>
        </div>
